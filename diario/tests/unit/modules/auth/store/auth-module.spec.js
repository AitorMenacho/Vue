...
describe('Vuex: Pruebas en el auth-module', () => {
    ...
    test('Mutation: loginUser', () => {
        ...
        const payload = {
            ...
            user: { name: 'Aitor', email: 'menacho.aitor@gmail.com' },
            idToken: 'ABC-123',
        ...
        expect(user).toEqual( { name: 'Aitor', email: 'menacho.aitor@gmail.com' } )
    ...
    test('Getter: username currentState', () => {
        ...
        expect( store.getters['auth/username'] ).toBe('Aitor')

    })


    //Actions
    test('Actions: create user - Error usuario ya existe', async() => {
    ...
    test('Actions: createUser SignUser - Crea el usuario', async() => {
        ...
        // Borrar el usuairo
        const deleteResp = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:delete?key=AIzaSyDbSOdvnM_fcsrP8n65HNOrxaE2PXRrnXo`, {
